...
namespace {
	function _local_exalib_export_function($function) {
	...
	if (_local_exalib_export_function('get_string')) {
		function local_exalib_get_string($identifier, $component = null, $a = null) {
            return '';
		}
	}
	if (_local_exalib_export_function('trans')) {
		function local_exalib_trans($string_or_strings, $arg_or_args = null) {
            return '';
		}
	}
}
